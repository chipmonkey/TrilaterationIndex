...
## Results of Experiment 1 - ANN Benchmarks
...
```{r kentucky_map, echo=FALSE, fig.cap="Geodesic Sample Data", fig.width=6, fig.height=4, dev='png'}
library('maps')
library('mapproj')
library(ggplot2)
...
```{r ann_geodesic_25, echo=FALSE, fig.cap="Queries Per Second for Geodesic (Q=150,000)", fig.width=6, fig.height=3}
library(knitr)
