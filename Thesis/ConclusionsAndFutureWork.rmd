...
There are a number of areas that we speculate, with minimal investiagtion, that Multilateration indexes and algorithms have benfits worth exploring.  A brief list of such areas that may be good for future investigation include:
