...
1. We take the same 150,000 point geospatial data set used in the $NN$ experiment (see [Geodesic query points] for details) and assign the points randomly to 15 categories.
