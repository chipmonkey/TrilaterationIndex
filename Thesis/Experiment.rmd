...
3. We implement the four algorithms described in [Multilateration NN Algorithms], namely "Trilateration" (TI), "TrilaterationApprox" (TIA), "TrilaterationExpand" (TIE), and "TrilaterationExpand2" (TIE2)
